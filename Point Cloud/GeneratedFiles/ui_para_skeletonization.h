...
public:
    ...
    void setupUi(QWidget *para_skeleton)
    {
        if (para_skeleton->objectName().isEmpty())
            para_skeleton->setObjectName(QStringLiteral("para_skeleton"));
        para_skeleton->resize(373, 861);
        tabWidget = new QTabWidget(para_skeleton);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setGeometry(QRect(0, 0, 351, 831));
        QFont font;
        font.setPointSize(9);
        ...
        skeleton_initial_sampling->setObjectName(QStringLiteral("skeleton_initial_sampling"));
        ...
        skeleton_initial_radius->setObjectName(QStringLiteral("skeleton_initial_radius"));
        ...
        skeleton_Radius_Growing_Speed->setObjectName(QStringLiteral("skeleton_Radius_Growing_Speed"));
        ...
        skeleton_mu->setObjectName(QStringLiteral("skeleton_mu"));
        ...
        skeleton_downsample_num->setObjectName(QStringLiteral("skeleton_downsample_num"));
        ...
        skeleton_full_auto->setObjectName(QStringLiteral("skeleton_full_auto"));
        ...
        local_density_radius->setObjectName(QStringLiteral("local_density_radius"));
        ...
        Stop_And_Grow_Error->setObjectName(QStringLiteral("Stop_And_Grow_Error"));
        ...
        Max_Iterate_Time->setObjectName(QStringLiteral("Max_Iterate_Time"));
        ...
        compute_density_2->setObjectName(QStringLiteral("compute_density_2"));
        ...
        Auto_Wlop_One_Step->setObjectName(QStringLiteral("Auto_Wlop_One_Step"));

        horizontalLayout_3->addWidget(Auto_Wlop_One_Step);

        iter_click_num = new QSpinBox(layoutWidget1);
        iter_click_num->setObjectName(QStringLiteral("iter_click_num"));
        ...
        skeleton_run_until_growth->setObjectName(QStringLiteral("skeleton_run_until_growth"));
        ...
        wlop_sigma_knn->setObjectName(QStringLiteral("wlop_sigma_knn"));
        ...
        PCA_Threshold->setObjectName(QStringLiteral("PCA_Threshold"));
        ...
        wlop_branch_search_sigma->setObjectName(QStringLiteral("wlop_branch_search_sigma"));
        ...
        wlop_accept_branch_size->setObjectName(QStringLiteral("wlop_accept_branch_size"));
        ...
        wlop_follow_sample_radius_2->setObjectName(QStringLiteral("wlop_follow_sample_radius_2"));
        ...
        wlop_branch_merge_dist->setObjectName(QStringLiteral("wlop_branch_merge_dist"));
        ...
        wlop_combine_too_close->setObjectName(QStringLiteral("wlop_combine_too_close"));
        ...
        Fix_original_weight_3->setObjectName(QStringLiteral("Fix_original_weight_3"));
        ...
        wlop_segment_length->setObjectName(QStringLiteral("wlop_segment_length"));
        ...
        wlop_branch_search_max_dist2->setObjectName(QStringLiteral("wlop_branch_search_max_dist2"));
        ...
        wlop_branch_search_max_dist->setObjectName(QStringLiteral("wlop_branch_search_max_dist"));
        ...
        wlop_clean_near_branch_dist->setObjectName(QStringLiteral("wlop_clean_near_branch_dist"));
        ...
        wlop_combine_angle->setObjectName(QStringLiteral("wlop_combine_angle"));
        ...
        wlop_follow_sample_radius->setObjectName(QStringLiteral("wlop_follow_sample_radius"));
        ...
        wlop_follow_sample_angle->setObjectName(QStringLiteral("wlop_follow_sample_angle"));
        ...
        wlop_grow_accept_sigma->setObjectName(QStringLiteral("wlop_grow_accept_sigma"));
        ...
        wlop_keep_virtual_angle->setObjectName(QStringLiteral("wlop_keep_virtual_angle"));
    ...
    {
        para_skeleton->setWindowTitle(QApplication::translate("para_skeleton", "L_1 Medial Skeleton", 0));
        groupBox_5->setTitle(QString());
        skeleton_initial_sampling->setText(QApplication::translate("para_skeleton", "Initial Sampling (stop play)", 0));
#ifndef QT_NO_TOOLTIP
        label_71->setToolTip(QApplication::translate("para_skeleton", "dsfafafaf", "ss"));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        label_71->setWhatsThis(QApplication::translate("para_skeleton", "afafafaf", "qqq"));
#endif // QT_NO_WHATSTHIS
#ifndef QT_NO_ACCESSIBILITY
        label_71->setAccessibleName(QApplication::translate("para_skeleton", "yyyy", 0));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_ACCESSIBILITY
        label_71->setAccessibleDescription(QApplication::translate("para_skeleton", "nnn", 0));
#endif // QT_NO_ACCESSIBILITY
        label_71->setText(QApplication::translate("para_skeleton", "Initial Radius (h0)", 0));
        label_12->setText(QApplication::translate("para_skeleton", "Neighborhood Growth Rate", 0));
        label_72->setText(QApplication::translate("para_skeleton", "Repulsion Mu", 0));
        label_30->setText(QApplication::translate("para_skeleton", "Initial Sampling Number", 0));
        skeleton_full_auto->setText(QApplication::translate("para_skeleton", "Play", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("para_skeleton", "L1 Skeleton", 0));
        label->setText(QApplication::translate("para_skeleton", "Current Radius:", 0));
        label_8->setText(QApplication::translate("para_skeleton", "Original Density Radius:", 0));
        label_16->setText(QApplication::translate("para_skeleton", "Min Error Before Growth", 0));
        label_17->setText(QApplication::translate("para_skeleton", "Max Iterate Before Growth", 0));
        compute_density_2->setText(QApplication::translate("para_skeleton", "Compute Density Weighting", 0));
        Auto_Wlop_One_Step->setText(QApplication::translate("para_skeleton", "Iterate (Step)", 0));
        label_4->setText(QApplication::translate("para_skeleton", "steps", 0));
        skeleton_run_until_growth->setText(QApplication::translate("para_skeleton", "Iterate Until Neighborhood Growth (Jump)", 0));
        label_24->setText(QApplication::translate("para_skeleton", "Sigma Smoothing KNN", 0));
        label_51->setText(QApplication::translate("para_skeleton", "Branch Identify Sigma", 0));
        label_26->setText(QApplication::translate("para_skeleton", "Branch Tracing Angle", 0));
        label_25->setText(QApplication::translate("para_skeleton", "@Branch Acceptant Size", 0));
        label_73->setText(QApplication::translate("para_skeleton", "Max Bridge Distance", 0));
        label_53->setText(QApplication::translate("para_skeleton", "@Bridge collapse Distance", 0));
        label_23->setText(QApplication::translate("para_skeleton", "Clean Too Close  Distance", 0));
        label_58->setText(QApplication::translate("para_skeleton", "Fix Original Weight", 0));
        label_59->setText(QApplication::translate("para_skeleton", "Branch Segment Length", 0));
        wlop_run_all_segment->setText(QApplication::translate("para_skeleton", "Refinement", 0));
        need_refinement->setText(QApplication::translate("para_skeleton", "Need refinement right away", 0));
        Step3_Clean_And_Update_Radius->setText(QApplication::translate("para_skeleton", "Step3 Update Radius", 0));
        Detect_Feature->setText(QApplication::translate("para_skeleton", "Step1 Detect_Skeleton_Features", 0));
        step2_search_branch->setText(QApplication::translate("para_skeleton", "Step2 Search New Branchs ", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("para_skeleton", "Advance Play", 0));
        label_22->setText(QApplication::translate("para_skeleton", "Branch Search Dist2", 0));
        label_21->setText(QApplication::translate("para_skeleton", "Branch Search Dist1", 0));
        label_54->setText(QApplication::translate("para_skeleton", "Clean NearBranch Dist", 0));
        label_60->setText(QApplication::translate("para_skeleton", "combine_angle", 0));
        label_61->setText(QApplication::translate("para_skeleton", "follow_sample_radius", 0));
        label_64->setText(QApplication::translate("para_skeleton", "follow_sample_angle", 0));
        label_69->setText(QApplication::translate("para_skeleton", "grow_accept_sigma", 0));
        label_70->setText(QApplication::translate("para_skeleton", "keep_virtual_angle", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("para_skeleton", "More parameters", 0));
    } // retranslateUi
